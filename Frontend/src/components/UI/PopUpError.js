const PopUpError = ({ message, messageinfo, onAccept, icon: Icon }) => {
  return (
    <div className="flex flex-col items-center h-fit w-auto min-w-[250px] rounded-xl border border-red5 bg-white ring-4 ring-inset ring-red2 ring-opacity-20 absolute z-50 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 px-[18px] py-[14px]">
      <div className="flex w-full">
        ...
        <div className="flex flex-col justify-center font-sans">
          ...
          <h2 className="text-xs h-auto text-blackText">{messageinfo}</h2>
        </div>
      </div>

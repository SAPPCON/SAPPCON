...
const Lastname = (props) => {
  ...
  const submitHandler = async (event) => {
    ...
    const enteredLastName = newlastNmeInputRef.current.value;


    if (!noEmptyValidate(enteredLastName)) {
      setErrorRequest("Ingresa tu apellido.");
      return;
    } else {
      setErrorRequest("");
    }
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(responseData.error || "Error al actualizar el apellido de usuario");
      }


      setCorrectRequest(true);
      newlastNmeInputRef.current.value ="";
      setErrorRequest("");
      ...
      <div className="flex justify-center px-[83px] pb-[130px]  pt-[14px]">
        <div className="mx-auto my-0 flex  max-w-[600px] grow flex-col">
          <div className="mb-[16px] mt-[8px] flex w-full  items-center text-[14px] ">
            ...
            <p className="font-sans text-[#C45500]">Cambia tú apellido</p>
          </div>
          ...
          <div className="flex flex-col rounded-[8px] border border-solid border-[#D5D9D9] px-[18px] py-[14px] font-sans">
            <div className="w-full text-[13px]">
              Si desea cambiar el apellido asociado a su cuenta, puede hacerlo a
              ...
              <form onSubmit={submitHandler}>
                ...
                <div className="mb-[22px]">
                  <input
                    ...
                    ref={newlastNmeInputRef}
                    placeholder={profileCtx.surname}
                  ></input>
                </div>

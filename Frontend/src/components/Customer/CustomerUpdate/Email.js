  ...
  const submitHandler = async (event) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw {
          message:
            responseData.message || "Error al actualizar el email del cliente",
        ...
        <div className="mx-auto my-0 flex  max-w-[600px] grow flex-col">
          <div className="mb-[16px] mt-[8px] flex w-full  items-center text-[14px] ">
            ...
            <p className="font-sans text-[#C45500]">
              Cambia el correo clectrónico del cliente
            </p>
          </div>
          ...
          {correctRequest && (
           ...
           "
            >
              ...
              Correo Electrónico del cliente actualizado.
            </div>
          )}
          ...
          <div className="flex flex-col rounded-[8px] border border-solid border-[#D5D9D9] px-[18px] py-[14px] font-sans">
            <div className="w-full text-[13px]">
              Si desea cambiar el correo electrónico asociado al cliente
              seleccionado, puede hacerlo a continuación. Asegúrese de hacer
              clic en botón

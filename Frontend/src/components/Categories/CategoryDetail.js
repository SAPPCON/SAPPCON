...
const CategoryDetail = (props) => {
  ...
  const [name, setName] = useState(props.categoryData.name);
  ...
  const handleNameChange = (e) => {
    ...
    setIsModified(e.target.value !== props.categoryData.name);
  };
  ...
  const handleSave = () => {
    ...
    categoryCtx.updateItem(props.categoryData, name);
  };
  ...
  const handleConfirmDelete = () => {
    setShowDelete(false);
    categoryCtx.deleteItem(props.categoryData._id);
    props.hideCategoryFunctionBackground();
  };
    ...
    <Fragment>
      <div className=" absolute top-1/3 left-1/2 transform -translate-x-1/2  z-40 bg-gray-100 rounded-[8px] border border-solid border-grayBorder w-[600px] ">
          ...
          >
            ...
            <div className="flex flex-col justify-center font-sans    ">
              <h1 className="text-lg  text-red5 ">
                {categoryCtx.errorUpdateName.message}
              </h1>
              <h2 className="  text-xs text-blackText ">
                {categoryCtx.errorUpdateName.messageinfo}
              </h2>
            </div>
          </div>
        )}
        ...
        <RxCross1
          ...
          onClick={props.hideCategoryFunctionBoth}
        ></RxCross1>
